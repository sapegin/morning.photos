...
export const SITE_TITLE = 'Artem Sapegin Photography';
export const SITE_DESCRIPTION =
	'Artem Sapegin Photography: landscapes, travel, cityscapes, nature, coffee';

export const ME_EMAIL = 'artem@sapegin.ru';
